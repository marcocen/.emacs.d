...
** Ledger
   ...
   Ledger is both a format and program designed for bookkeping. It uses a
   double-entry style and it's what I am trying to use to keep track of my
   expenses.
...
** Gnus
   ...
   #+BEGIN_SRC emacs-lisp
     (setq gnus-select-method '(nnimap "imap.fing.edu.uy"))
